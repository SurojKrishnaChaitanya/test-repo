// Static multi-sensor input sequence — IMDAA Reanalysis combined with
...
export const satelliteFramesData = [
  ...
  },
  {
    ...
    caption: '30 minutes later, the primary core at 10.5°N has remained stationary over topography, intensifying to dark red (>120 mm/hr) with rapid INSAT-3DR CTT cooling (-8°C/30min) and IMDAA moisture convergence.',
  },
];

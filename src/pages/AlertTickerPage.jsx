...
export default function AlertTickerPage() {
  ...
  // Live alert data — polls the alerting API every 5s when
  // VITE_USE_REAL_ALERTS=true (see alertingService.js), scoped to
  // selectedRegion when one is set. Falls back to alertsData automatically
  ...
  return (
    <div className="relative h-full overflow-y-auto bg-gradient-to-br from-slate-50 via-slate-100/50 to-amber-50/20 p-6 text-slate-900">
